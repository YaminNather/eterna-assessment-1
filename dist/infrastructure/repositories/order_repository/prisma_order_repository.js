...
import { OrderStatus as OrderStatusDb, OrderFailureReason as OrderFailureReasonDb, Dex, } from "../../../generated/prisma/client.js";
...
function mapOrderStatusToDb(domainModel) {
    switch (domainModel) {
...
function mapOrderStatusFromDb(db) {
    switch (db) {
...
function mapFailureReasonToDb(domainModel) {
    switch (domainModel) {
...
function mapFailureReasonFromDb(db) {
    switch (db) {
